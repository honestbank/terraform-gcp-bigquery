...
|------|-------------|------|---------|:--------:|
| <a name="input_default_table_expiration_ms"></a> [default\_table\_expiration\_ms](#input\_default\_table\_expiration\_ms) | Optional default expiration for tables in this dataset, in milliseconds. Null = no default. | `number` | `null` | no |
